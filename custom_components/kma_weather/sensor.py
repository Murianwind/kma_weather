...
# 모든 센서 타입 정의 (총 23종)
# Problem 4 해결: 단위를 'µg/m³'(U+00B5)로 수정하여 HA 표준 호환성 확보
SENSOR_TYPES = {
...
class KMACustomSensor(CoordinatorEntity, SensorEntity):
    ...
    def native_value(self):
        ...
        # Problem 1: 오늘 최고/최저 기온은 코디네이터 내부 변수를 우선 참조하여 연동 보장
